                ...
                <div class="col-12">
                    <div class="explorer-container">
                        ...
                        <div id="folderCanvas" class="view-grid-big">
                            @php
                                $folders = [
                                    ['name' => 'Reports', 'files' => '24 Files', 'url' => route('nse.segment.archives', ['segment' => $segment, 'folder' => 'reports'])],
                                    ['name' => 'Common', 'files' => '18 Files', 'url' => route('nse.segment.archives', ['segment' => $segment, 'folder' => 'common'])]
                                ];
                            @endphp
