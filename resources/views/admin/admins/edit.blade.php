    ...
    <div class="container mt-4">
        <form method="post" action="{{ route('admins.update', $user->id) }}">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $user->first_name }}" type="text" class="form-control" name="first_name" placeholder="Name" required>
            ...
            <a href="{{ route('admins') }}" class="btn btn-default">Cancel</button>
        </form>
    </div>
